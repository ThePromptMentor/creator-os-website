        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Choose the plan that fits your needs. Start free and scale as you grow your creator business.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="feature-card text-center">
              <div className="mb-6">
                ...
                <p className="text-gray-600">Perfect for new creators getting started</p>
              </div>
              <div className="mb-6">
            ...
            {/* Pro Plan */}
            <div className="feature-card text-center border-2 border-blue-500 relative">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600">For growing creators and small teams</p>
              </div>
              <div className="mb-6">
            ...
            <div className="feature-card text-center">
              <div className="mb-6">
                ...
                <p className="text-gray-600">For agencies and large creator teams</p>
              </div>
              <div className="mb-6">
              ...
              <ul className="space-y-3 mb-8 text-left">
                ...
                <li className="flex items-center">
                  ...
                  <span>Enterprise monetization</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            ...
            <div className="space-y-8">
              <div className="feature-card">
                ...
                <p className="text-gray-600">
                  Yes! You can upgrade, downgrade, or cancel your plan at any time. Changes take effect immediately for upgrades and at the end of your billing cycle for downgrades.
                </p>
              </div>
              ...
              <div className="feature-card">
                ...
                <p className="text-gray-600">
                  We offer a 14-day free trial for Pro and Enterprise plans. No credit card required to start your free trial.
                </p>
              </div>
              ...
              <div className="feature-card">
                ...
                <p className="text-gray-600">
                  We offer a 30-day money-back guarantee. If you're not satisfied with CreatorOS, we'll refund your first month's payment.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <p className="text-xl text-blue-100">
              Join thousands of creators who trust CreatorOS to manage and grow their businesses.
            </p>
